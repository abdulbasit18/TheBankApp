//
//  ValidationControllerTests.swift
//  TheBankAppTests
//
...
class ValidationTests: XCTestCase {
    ...
    override func setUp() {
        ...
        navigation = ValidationCoordinator(rootViewController: mockNavigationController)
        navigation.start()
        viewModel = ValidationViewModel(service)
    }
    
    func testViewModelInitialState() {
        XCTAssertTrue(navigation.navigationController.topViewController is ValidationController)
